...
PANEL_HW_SOURCE_Visu=C:/SharedFolder/CControl/Physical/2_07/Hardware.hw 
DIS_OBJECTS_Visu=$(PANEL_HW_OBJECT_Visu) $(KEYMAP_OBJECTS_Visu)

# KeyMapping flags
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/2_07/4PPC30_0702_21B/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'S4.93' -L 'visapi: V*' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/2_07/4PPC30_0702_21B/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.73.5/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'CControl' -sfas -vcob '$(VCOBJECT_Visu)'
...
KEYMAP_SOURCES_Visu=$(AS_PROJECT_PATH)/Physical/2_07/4PPC30_0702_21B/VC/4PPC30_0702_21B.dis $(AS_PROJECT_PATH)/Physical/2_07/4PPC30_0702_21B/VC/PS2-Keyboard.dis 
...
$(TEMP_PATH_Visu)/tpr.AlphaPadC307Zoll.vco: $(AS_PROJECT_PATH)/Logical/Visualisierung/Visu/TouchPads/AlphaPadC307Zoll.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'C:/SharedFolder/CControl/Logical/Visualisierung/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4735 -sfas
