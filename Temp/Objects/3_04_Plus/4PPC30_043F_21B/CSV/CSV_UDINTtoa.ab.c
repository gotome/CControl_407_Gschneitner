...
#include "C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/CSV/CSV_UDINTtoaab.h"
#line 1 "C:/SharedFolder/CControl/Logical/CSV/Library/CSV/CSV_UDINTtoa.nodebug"
#line 19 "C:/SharedFolder/CControl/Logical/CSV/Library/CSV/CSV_UDINTtoa.ab"
void CSV_UDINTtoa(struct CSV_UDINTtoa* inst){struct CSV_UDINTtoa* __inst__=inst;


__AS__MEMSET(((unsigned long)(&__inst__->Ausg_ASCII)),0,11);
(__inst__->Ausg_ASCII[CheckBounds(0,0,10)]=48);

if((((unsigned long)__inst__->Ausg_ASCII_len>=(unsigned long)11))){

(__inst__->i=0);
(__inst__->M_Start=0);
(__inst__->Ausg_Fehler=0);

for((__inst__->ii=9);__inst__->ii>=0;__inst__->ii--){
if((((unsigned long)(((unsigned long)(__inst__->Eing_UDINT))/((unsigned long)(CheckDivUdint((unsigned long)(RealExpt(10,__inst__->ii)>=0.0?RealExpt(10,__inst__->ii)+0.5:RealExpt(10,__inst__->ii)-0.5)))))>(unsigned long)0))){
(__inst__->M_Start=1);
}
if((((unsigned long)(unsigned char)__inst__->M_Start==(unsigned long)(unsigned char)1))){
(__inst__->Ausg_ASCII[CheckBounds(__inst__->i,0,10)]=(unsigned char)((((unsigned long)(__inst__->Eing_UDINT))/((unsigned long)(CheckDivUdint((unsigned long)(RealExpt(10,__inst__->ii)>=0.0?RealExpt(10,__inst__->ii)+0.5:RealExpt(10,__inst__->ii)-0.5)))))+48));
(__inst__->Eing_UDINT=(__inst__->Eing_UDINT-((unsigned long)(__inst__->Ausg_ASCII[CheckBounds(__inst__->i,0,10)]-48)*(unsigned long)(RealExpt(10,__inst__->ii)>=0.0?RealExpt(10,__inst__->ii)+0.5:RealExpt(10,__inst__->ii)-0.5))));
(__inst__->i=(__inst__->i+1));
}
if(__inst__->ii<=0)break;}

__AS__MEMCPY(__inst__->Ausg_ASCII_adr,((unsigned long)(&__inst__->Ausg_ASCII)),11);

}else{

(__inst__->Ausg_Fehler=1);
__AS__MEMCPY(__inst__->Ausg_ASCII_adr,((unsigned long)(&__inst__->Ausg_ASCII)),4);

}

imp1_end0_0:;}
#line 51 "C:/SharedFolder/CControl/Logical/CSV/Library/CSV/CSV_UDINTtoa.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/CSV/CSV_UDINTtoa.ab.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/CSV/CSV_UDINTtoa.ab.c\\\" \\\"C:/SharedFolder/CControl/Logical/CSV/Library/CSV/CSV_UDINTtoa.ab\\\"\\n\"");
