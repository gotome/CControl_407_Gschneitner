...
export AS_STATIC_ARCHIVES_PATH := C:/SharedFolder/CControl/Temp/Archives/3_04_Plus/4PPC30_043F_21B
export AS_CPU_PATH := C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B
export AS_CPU_PATH_2 := C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B
export AS_TEMP_PATH := C:/SharedFolder/CControl/Temp
export AS_BINARIES_PATH := C:/SharedFolder/CControl/Binaries
export AS_PROJECT_CPU_PATH := C:/SharedFolder/CControl/Physical/3_04_Plus/4PPC30_043F_21B
export AS_PROJECT_CONFIG_PATH := C:/SharedFolder/CControl/Physical/3_04_Plus
export AS_PROJECT_PATH := C:/SharedFolder/CControl
export AS_PROJECT_NAME := CControl
export AS_PLC := 4PPC30_043F_21B
export AS_TEMP_PLC := 4PPC30_043F_21B
export AS_USER_NAME := gries
export AS_CONFIGURATION := 3_04_Plus
...
default: \
	$(AS_CPU_PATH)/Visu4Z.br \



include $(AS_CPU_PATH)/Visu4Z/Visu4Z.mak
