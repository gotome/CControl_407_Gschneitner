...
#include "C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoUtil/fbLascoBrStfLstst.h"
#line 1 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoBrStfLst.nodebug"
#line 13 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoBrStfLst.st"
void fbLascoBrStfLst(struct fbLascoBrStfLst* inst){struct fbLascoBrStfLst* __inst__=inst;{


if(__inst__->sekTick){

(__inst__->LeistungSek=(__inst__->LeistungAkt/CheckDivReal(3600)));
(CheckWriteAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh))=((CheckReadAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh)))+__inst__->LeistungSek));

if((((CheckReadAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh)))>=10))){
(CheckWriteAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh))=((CheckReadAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh)))-10));
(CheckWriteAccess(__inst__->Leistung_MWh),(*(__inst__->Leistung_MWh))=((CheckReadAccess(__inst__->Leistung_MWh),(*(__inst__->Leistung_MWh)))+1));
}
}

if(__inst__->Reset){
(CheckWriteAccess(__inst__->Leistung_kWh),(*(__inst__->Leistung_kWh))=0);
(CheckWriteAccess(__inst__->Leistung_MWh),(*(__inst__->Leistung_MWh))=0);
}


}imp1_else2_0:imp1_end2_0:;}
#line 33 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoBrStfLst.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoUtil/fbLascoBrStfLst.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoUtil/fbLascoBrStfLst.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoBrStfLst.st\\\"\\n\"");
