...
#include "C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoTrock/fbTrockZeitprogrammst.h"
#line 1 "C:/SharedFolder/CControl/Logical/Libraries/LascoTrock/fbTrockZeitprogramm.nodebug"
#line 13 "C:/SharedFolder/CControl/Logical/Libraries/LascoTrock/fbTrockZeitprogramm.st"
...
(__inst__->FreigZeitfenster4=0);
if(((__inst__->StartZeit4>__inst__->StoppZeit4))){
if((((__inst__->AktZeit>=__inst__->StartZeit4))|((__inst__->AktZeit<__inst__->StoppZeit4)))){
(__inst__->FreigZeitfenster4=1);
}
}else{
if((((__inst__->AktZeit>=__inst__->StartZeit4))&((__inst__->AktZeit<__inst__->StoppZeit4)))){
(__inst__->FreigZeitfenster4=1);
...
(__inst__->FreigZeitfenster5=0);
if(((__inst__->StartZeit5>__inst__->StoppZeit5))){
if((((__inst__->AktZeit>=__inst__->StartZeit5))|((__inst__->AktZeit<__inst__->StoppZeit5)))){
(__inst__->FreigZeitfenster5=1);
}
}else{
if((((__inst__->AktZeit>=__inst__->StartZeit5))&((__inst__->AktZeit<__inst__->StoppZeit5)))){
(__inst__->FreigZeitfenster5=1);
...
(__inst__->FreigabeZeitprogramm=(__inst__->FreigZeitfenster1|__inst__->FreigZeitfenster2|__inst__->FreigZeitfenster3|__inst__->FreigZeitfenster4|__inst__->FreigZeitfenster5));
...
(__inst__->FreigZeitfenster4=0);
(__inst__->FreigZeitfenster5=0);
(__inst__->FreigabeZeitprogramm=0);

}


}imp1_end0_0:;}
#line 92 "C:/SharedFolder/CControl/Logical/Libraries/LascoTrock/fbTrockZeitprogramm.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoTrock/fbTrockZeitprogramm.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/LascoTrock/fbTrockZeitprogramm.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/Libraries/LascoTrock/fbTrockZeitprogramm.st\\\"\\n\"");
