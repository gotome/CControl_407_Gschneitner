...
#include "C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/io304/Mainst.h"
#line 1 "C:/SharedFolder/CControl/Logical/IO/io304/Main.nodebug"
#line 3 "C:/SharedFolder/CControl/Logical/IO/io304/Main.st"
void __BUR__ENTRY_INIT_FUNCT__(void){{

(hmiStatus.NameSteuerung=3);


}}
#line 8 "C:/SharedFolder/CControl/Logical/IO/io304/Main.nodebug"
#line 12 "C:/SharedFolder/CControl/Logical/IO/io304/Main.st"
...
(hmiParameter.Ausstattung.BeideVentAusBeiUmschBoxenkl=0);
(hmiParameter.Ausstattung.BeideVentAusBeiUmschBypasskl=0);
(hmiParameter.Ausstattung.Brandschutzklappe=0);
(hmiParameter.Ausstattung.Heizregister=0);
(hmiParameter.Ausstattung.HeizregisterDrehzahlvorgabe=0);
(hmiParameter.Ausstattung.LuftmngReglerFrischlVent2=0);
(hmiParameter.Ausstattung.LuftmngReglerUmluftVent2=0);
(hmiParameter.Ausstattung.Notstromaggregat=0);
(hmiParameter.Ausstattung.Scheitholzofen=0);
(hmiParameter.Ausstattung.SensorTrockenluft=0);
(hmiParameter.Ausstattung.Vent2AusWennUmschUmluftkl=0);
(hmiParameter.Ausstattung.Ventilator2=0);
(hmiParameter.Ausstattung.Warmluftofen=0);
(hmiParameter.Ausstattung.WarmluftofenBetriebsmldg=0);
(hmiParameter.Ausstattung.WarmluftofenTempVorgabe=0);

if(hmiParameter.Ausstattung.SensorFrischluft){
(hmiParameter.Ausstattung.SensorDachluft=0);
}else if(hmiParameter.Ausstattung.SensorDachluft){
(hmiParameter.Ausstattung.SensorFrischluft=0);
}
...
(diAnfEntfeuchterExtern=diModul02.di10);
(diVentilator1InBetrieb=diModul02.di11);
(diDrehfeldIstKorrekt=diModul02.di12);
...
(doModul03.do09=doBypassklappeSchliessen);
(doModul03.do10=doUmluftklappe1Oeffnen);
(doModul03.do11=doUmluftklappe1Schliessen);
...
(LCRMovAvgFlt_2.enable=1);;(LCRMovAvgFlt_2.x=aiModul04.ai03);;(LCRMovAvgFlt_2.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_2);
(LCRMovAvgFlt_3.enable=1);;(LCRMovAvgFlt_3.x=aiModul04.ai04);;(LCRMovAvgFlt_3.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_3);
(LCRMovAvgFlt_4.enable=1);;(LCRMovAvgFlt_4.x=aiModul04.ai05);;(LCRMovAvgFlt_4.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_4);
(LCRMovAvgFlt_5.enable=1);;(LCRMovAvgFlt_5.x=aiModul04.ai06);;(LCRMovAvgFlt_5.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_5);
(LCRMovAvgFlt_6.enable=1);;(LCRMovAvgFlt_6.x=aiModul04.ai07);;(LCRMovAvgFlt_6.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_6);
(LCRMovAvgFlt_7.enable=1);;(LCRMovAvgFlt_7.x=aiModul04.ai08);;(LCRMovAvgFlt_7.base=30);;LCRMovAvgFlt(&LCRMovAvgFlt_7);
}
...
(LCRLimScal_1.x=LCRMovAvgFlt_1.y);;(LCRLimScal_1.x1=0);;(LCRLimScal_1.y1=Betriebsparameter.Sensoren.HochdruckMessberMin);;(LCRLimScal_1.x2=32767);;(LCRLimScal_1.y2=Betriebsparameter.Sensoren.HochdruckMessberMax);;LCRLimScal(&LCRLimScal_1);
(aiHochdruckModul1=(LCRLimScal_1.y+Betriebsparameter.Sensoren.OffsetHochdruckModul1));



(LCRLimScal_2.x=LCRMovAvgFlt_2.y);;(LCRLimScal_2.x1=0);;(LCRLimScal_2.y1=(-3.00000000000000000000E+01));;(LCRLimScal_2.x2=32767);;(LCRLimScal_2.y2=(7.00000000000000000000E+01));;LCRLimScal(&LCRLimScal_2);
(aiEintrittTemperatur=(LCRLimScal_2.y+Betriebsparameter.Sensoren.OffsetEintrittTemp));



(LCRLimScal_3.x=LCRMovAvgFlt_3.y);;(LCRLimScal_3.x1=0);;(LCRLimScal_3.y1=(0.00000000000000000000E+00));;(LCRLimScal_3.x2=32767);;(LCRLimScal_3.y2=(1.00000000000000000000E+02));;LCRLimScal(&LCRLimScal_3);
(aiEintrittFeuchte=(LCRLimScal_3.y+Betriebsparameter.Sensoren.OffsetEintrittFeuchte));



(LCRLimScal_4.x=LCRMovAvgFlt_4.y);;(LCRLimScal_4.x1=0);;(LCRLimScal_4.y1=(-3.00000000000000000000E+01));;(LCRLimScal_4.x2=32767);;(LCRLimScal_4.y2=(7.00000000000000000000E+01));;LCRLimScal(&LCRLimScal_4);
(aiAustrittTemperatur=(LCRLimScal_4.y+Betriebsparameter.Sensoren.OffsetAustrittTemp));



(LCRLimScal_5.x=LCRMovAvgFlt_5.y);;(LCRLimScal_5.x1=0);;(LCRLimScal_5.y1=(0.00000000000000000000E+00));;(LCRLimScal_5.x2=32767);;(LCRLimScal_5.y2=(1.00000000000000000000E+02));;LCRLimScal(&LCRLimScal_5);
(aiAustrittFeuchte=(LCRLimScal_5.y+Betriebsparameter.Sensoren.OffsetAustrittFeuchte));


if(Betriebsparameter.Ausstattung.SensorDachluft){


(LCRLimScal_6.x=LCRMovAvgFlt_6.y);;(LCRLimScal_6.x1=0);;(LCRLimScal_6.y1=(-3.00000000000000000000E+01));;(LCRLimScal_6.x2=32767);;(LCRLimScal_6.y2=(7.00000000000000000000E+01));;LCRLimScal(&LCRLimScal_6);
(aiDachluftTemperatur=(LCRLimScal_6.y+Betriebsparameter.Sensoren.OffsetDachTemp));



(LCRLimScal_7.x=LCRMovAvgFlt_7.y);;(LCRLimScal_7.x1=0);;(LCRLimScal_7.y1=(0.00000000000000000000E+00));;(LCRLimScal_7.x2=32767);;(LCRLimScal_7.y2=(1.00000000000000000000E+02));;LCRLimScal(&LCRLimScal_7);
...
(cmModul05.do01=doUmluftklappe2Oeffnen);
(cmModul05.do02=doUmluftklappe2Schliessen);
...
(LCRLimScal_8.x=LCRMovAvgFlt_8.y);;(LCRLimScal_8.x1=0);;(LCRLimScal_8.y1=Betriebsparameter.Sensoren.LuftgeschwMessberMin);;(LCRLimScal_8.x2=32767);;(LCRLimScal_8.y2=Betriebsparameter.Sensoren.LuftgeschwMessberMax);;LCRLimScal(&LCRLimScal_8);
(aiLuftgeschwindigkeit=(LCRLimScal_8.y+Betriebsparameter.Sensoren.OffsetLuftgeschw));



(LCRLimScal_9.x=aoDrehzahlvorgKompressorModul1);;(LCRLimScal_9.x1=0);;(LCRLimScal_9.y1=0);;(LCRLimScal_9.x2=Betriebsparameter.Kompressor1.DrehzahlMax);;(LCRLimScal_9.y2=32767);;LCRLimScal(&LCRLimScal_9);
(cmModul05.ao01=(signed short)(LCRLimScal_9.y>=0.0?LCRLimScal_9.y+0.5:LCRLimScal_9.y-0.5));
...
if(sekTick){
(LCRMovAvgFlt_12.enable=1);;(LCRMovAvgFlt_12.x=cmModul06.ai01);;(LCRMovAvgFlt_12.base=Betriebsparameter.Sensoren.FilterzeitAbluft);;LCRMovAvgFlt(&LCRMovAvgFlt_12);
}



(LCRLimScal_16.x=LCRMovAvgFlt_12.y);;(LCRLimScal_16.x1=0);;(LCRLimScal_16.y1=(-3.00000000000000000000E+01));;(LCRLimScal_16.x2=32767);;(LCRLimScal_16.y2=(7.00000000000000000000E+01));;LCRLimScal(&LCRLimScal_16);
(aiAbluftTemperatur=(LCRLimScal_16.y+Betriebsparameter.Sensoren.OffsetAbluftTemp));


(LCRLimScal_10.x=aoDrehzahlvorgVentilator1);;(LCRLimScal_10.x1=(0.00000000000000000000E+00));;(LCRLimScal_10.y1=0);;(LCRLimScal_10.x2=(1.00000000000000000000E+02));;(LCRLimScal_10.y2=32767);;LCRLimScal(&LCRLimScal_10);
(cmModul06.ao01=(signed short)(LCRLimScal_10.y>=0.0?LCRLimScal_10.y+0.5:LCRLimScal_10.y-0.5));
...
(cmModul07.do01=(doAbluftklappeOeffnen|doAbluftventilatorEin));
(cmModul07.do02=doAbluftklappeSchliessen);


if(sekTick){
(LCRMovAvgFlt_9.enable=1);;(LCRMovAvgFlt_9.x=cmModul07.ai01);;(LCRMovAvgFlt_9.base=Betriebsparameter.Sensoren.FilterzeitAbluft);;LCRMovAvgFlt(&LCRMovAvgFlt_9);
}



(LCRLimScal_11.x=LCRMovAvgFlt_9.y);;(LCRLimScal_11.x1=0);;(LCRLimScal_11.y1=(0.00000000000000000000E+00));;(LCRLimScal_11.x2=32767);;(LCRLimScal_11.y2=(1.00000000000000000000E+02));;LCRLimScal(&LCRLimScal_11);
(aiAbluftFeuchte=(LCRLimScal_11.y+Betriebsparameter.Sensoren.OffsetAbluftFeuchte));


(LCRLimScal_12.x=aoDrehzahlvorgAbluftventilator);;(LCRLimScal_12.x1=(0.00000000000000000000E+00));;(LCRLimScal_12.y1=0);;(LCRLimScal_12.x2=(1.00000000000000000000E+02));;(LCRLimScal_12.y2=32767);;LCRLimScal(&LCRLimScal_12);
(cmModul07.ao01=(signed short)(LCRLimScal_12.y>=0.0?LCRLimScal_12.y+0.5:LCRLimScal_12.y-0.5));
...
if(sekTick){
(LCRMovAvgFlt_10.enable=1);;(LCRMovAvgFlt_10.x=cmModul10.ai01);;(LCRMovAvgFlt_10.base=Betriebsparameter.Sensoren.FilterzeitNiederdruck);;LCRMovAvgFlt(&LCRMovAvgFlt_10);
}



(LCRLimScal_13.x=LCRMovAvgFlt_10.y);;(LCRLimScal_13.x1=0);;(LCRLimScal_13.y1=Betriebsparameter.Sensoren.NiederdruckMessberMin);;(LCRLimScal_13.x2=32767);;(LCRLimScal_13.y2=Betriebsparameter.Sensoren.NiederdruckMessberMax);;LCRLimScal(&LCRLimScal_13);
(aiNiederdruckModul2=(LCRLimScal_13.y+Betriebsparameter.Sensoren.OffsetNiederdruckModul2));



(LCRLimScal_14.x=aoDrehzahlvorgKompressorModul2);;(LCRLimScal_14.x1=0);;(LCRLimScal_14.y1=0);;(LCRLimScal_14.x2=Betriebsparameter.Kompressor2.DrehzahlMax);;(LCRLimScal_14.y2=32767);;LCRLimScal(&LCRLimScal_14);
(cmModul10.ao01=(signed short)(LCRLimScal_14.y>=0.0?LCRLimScal_14.y+0.5:LCRLimScal_14.y-0.5));
...
if(sekTick){
(LCRMovAvgFlt_11.enable=1);;(LCRMovAvgFlt_11.x=cmModul11.ai01);;(LCRMovAvgFlt_11.base=Betriebsparameter.Sensoren.FilterzeitHochdruck);;LCRMovAvgFlt(&LCRMovAvgFlt_11);
}



(LCRLimScal_15.x=LCRMovAvgFlt_11.y);;(LCRLimScal_15.x1=0);;(LCRLimScal_15.y1=Betriebsparameter.Sensoren.HochdruckMessberMin);;(LCRLimScal_15.x2=32767);;(LCRLimScal_15.y2=Betriebsparameter.Sensoren.HochdruckMessberMax);;LCRLimScal(&LCRLimScal_15);
...
if(sekTick){
(LCRMovAvgFlt_13.enable=1);;(LCRMovAvgFlt_13.x=cmModul12.ai01);;(LCRMovAvgFlt_13.base=Betriebsparameter.Sensoren.FilterzeitKanaldruck);;LCRMovAvgFlt(&LCRMovAvgFlt_13);
}



(LCRLimScal_0.x=LCRMovAvgFlt_13.y);;(LCRLimScal_0.x1=0);;(LCRLimScal_0.y1=Betriebsparameter.Sensoren.KanaldruckMessberMin);;(LCRLimScal_0.x2=32767);;(LCRLimScal_0.y2=Betriebsparameter.Sensoren.KanaldruckMessberMax);;LCRLimScal(&LCRLimScal_0);
...
(hmiIoTest.DigitalIn.diAnfEntfeuchterExtern=diModul02.di10);
(hmiIoTest.DigitalIn.diVentilator1InBetrieb=diModul02.di11);
(hmiIoTest.DigitalIn.diDrehfeldIstKorrekt=diModul02.di12);
...
(doModul03.do09=hmiIoTest.DigitalOut.doBypassklappeSchliessen);
(doModul03.do10=hmiIoTest.DigitalOut.doUmluftklappe1Oeffnen);
(doModul03.do11=hmiIoTest.DigitalOut.doUmluftklappe1Schliessen);
...
(cmModul05.do01=hmiIoTest.DigitalOut.doUmluftklappe2Oeffnen);
(cmModul05.do02=hmiIoTest.DigitalOut.doUmluftklappe2Schliessen);
...
(LCRLimScal_9.x=hmiIoTest.AnalogOut.aoDrehzahlvorgKompressorModul1);;(LCRLimScal_9.x1=0);;(LCRLimScal_9.y1=0);;(LCRLimScal_9.x2=Betriebsparameter.Kompressor1.DrehzahlMax);;(LCRLimScal_9.y2=32767);;LCRLimScal(&LCRLimScal_9);
(cmModul05.ao01=(signed short)(LCRLimScal_9.y>=0.0?LCRLimScal_9.y+0.5:LCRLimScal_9.y-0.5));
...
(LCRLimScal_10.x=hmiIoTest.AnalogOut.aoDrehzahlvorgVentilator1);;(LCRLimScal_10.x1=(0.00000000000000000000E+00));;(LCRLimScal_10.y1=0);;(LCRLimScal_10.x2=(1.00000000000000000000E+02));;(LCRLimScal_10.y2=32767);;LCRLimScal(&LCRLimScal_10);
(cmModul06.ao01=(signed short)(LCRLimScal_10.y>=0.0?LCRLimScal_10.y+0.5:LCRLimScal_10.y-0.5));
...
(cmModul07.do01=(hmiIoTest.DigitalOut.doAbluftklappeOeffnen|hmiIoTest.DigitalOut.doAbluftventilatorEin));
(cmModul07.do02=hmiIoTest.DigitalOut.doAbluftklappeSchliessen);
...
(LCRLimScal_12.x=hmiIoTest.AnalogOut.aoDrehzahlvorgAbluftventilator);;(LCRLimScal_12.x1=(0.00000000000000000000E+00));;(LCRLimScal_12.y1=0);;(LCRLimScal_12.x2=(1.00000000000000000000E+02));;(LCRLimScal_12.y2=32767);;LCRLimScal(&LCRLimScal_12);
(cmModul07.ao01=(signed short)(LCRLimScal_12.y>=0.0?LCRLimScal_12.y+0.5:LCRLimScal_12.y-0.5));
...
(LCRLimScal_14.x=hmiIoTest.AnalogOut.aoDrehzahlvorgKompressorModul2);;(LCRLimScal_14.x1=0);;(LCRLimScal_14.y1=0);;(LCRLimScal_14.x2=Betriebsparameter.Kompressor2.DrehzahlMax);;(LCRLimScal_14.y2=32767);;LCRLimScal(&LCRLimScal_14);
(cmModul10.ao01=(signed short)(LCRLimScal_14.y>=0.0?LCRLimScal_14.y+0.5:LCRLimScal_14.y-0.5));
...
(loc_Erforderl_Mod6=(Betriebsparameter.Ausstattung.Box2|Betriebsparameter.Ausstattung.Box3|Betriebsparameter.Ausstattung.SensorAbluft|Betriebsparameter.Ausstattung.Ventilator1));
(loc_Erforderl_Mod7=(Betriebsparameter.Ausstattung.Abluftklappe|Betriebsparameter.Ausstattung.Abluftventilator|Betriebsparameter.Ausstattung.SensorAbluft));
(loc_Erforderl_Mod8=0);
(loc_Erforderl_Mod9=Betriebsparameter.Ausstattung.Energiemessung);
(loc_Erforderl_Mod10=gModul2Vorhanden);
(loc_Erforderl_Mod11=gModul2Vorhanden);
(loc_Erforderl_Mod12=Betriebsparameter.Ausstattung.SensorKanaldruck);
...
(fbLascoFehl_0.FehlerIn=((loc_Erforderl_Mod1&(brModul01.ModulOk^1))|(loc_Erforderl_Mod2&(diModul02.ModulOk^1))|(loc_Erforderl_Mod3&(doModul03.ModulOk^1))|(loc_Erforderl_Mod4&(aiModul04.ModulOk^1))|(loc_Erforderl_Mod5&(cmModul05.ModulOk^1))|(loc_Erforderl_Mod6&(cmModul06.ModulOk^1))|(loc_Erforderl_Mod7&(cmModul07.ModulOk^1))|(loc_Erforderl_Mod8&(atModul08.ModulOk^1))|(loc_Erforderl_Mod9&(gEnergiemessungModulOk^1))|(loc_Erforderl_Mod10&(cmModul10.ModulOk^1))|(loc_Erforderl_Mod11&(cmModul11.ModulOk^1))|(loc_Erforderl_Mod12&(cmModul12.ModulOk^1))));
...
#line 1126 "C:/SharedFolder/CControl/Logical/IO/io304/Main.nodebug"
...
__asm__(".ascii \"iecfile \\\"Logical/IO/io304/Types.typ\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Logical/IO/io304/Variables.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/io304/Main.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/3_04_Plus/4PPC30_043F_21B/io304/Main.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/IO/io304/Main.st\\\"\\n\"");
__asm__(".previous");
