...
export WIN32_AS_PROJECT_PATH := "C:\SharedFolder\CControl_407_Gschneitner"
...
export WIN32_AS_TEMP_PATH := "C:\SharedFolder\CControl_407_Gschneitner\Temp"
export WIN32_AS_BINARIES_PATH := "C:\SharedFolder\CControl_407_Gschneitner\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/CControl_Gschneitner.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Rebuild'   
