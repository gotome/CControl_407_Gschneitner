...
(TOF_VerzUmschaltungAbluftvent.IN=(hmiButtons.changeBetrArtAbluftvent&~Edge0000100012&1?((Edge0000100012=hmiButtons.changeBetrArtAbluftvent&1),1):((Edge0000100012=hmiButtons.changeBetrArtAbluftvent&1),0)));;(TOF_VerzUmschaltungAbluftvent.PT=hmiParameter.Allgemein.VerzoegerungAenderungKlappen);;TOF(&TOF_VerzUmschaltungAbluftvent);
...
if((~TOF_VerzUmschaltungAbluftvent.Q&Edge0000100013&1?((Edge0000100013=TOF_VerzUmschaltungAbluftvent.Q&1),1):((Edge0000100013=TOF_VerzUmschaltungAbluftvent.Q&1),0))){
if((((unsigned long)(unsigned char)hmiStatus.Abluftventilator.IndexBetriebsart==(unsigned long)(unsigned char)0))){
...
(TOF_VerzUmschaltungAbluftklappe.IN=(hmiButtons.changeBetrArtAbluftklappe&~Edge0000100014&1?((Edge0000100014=hmiButtons.changeBetrArtAbluftklappe&1),1):((Edge0000100014=hmiButtons.changeBetrArtAbluftklappe&1),0)));;(TOF_VerzUmschaltungAbluftklappe.PT=hmiParameter.Allgemein.VerzoegerungAenderungKlappen);;TOF(&TOF_VerzUmschaltungAbluftklappe);
...
if((~TOF_VerzUmschaltungAbluftklappe.Q&Edge0000100015&1?((Edge0000100015=TOF_VerzUmschaltungAbluftklappe.Q&1),1):((Edge0000100015=TOF_VerzUmschaltungAbluftklappe.Q&1),0))){
if((((unsigned long)(unsigned char)hmiStatus.Abluftklappe.IndexBetriebsart==(unsigned long)(unsigned char)0))){
...
if((hmiBoxAktuell.Aus&~Edge0000100016&1?((Edge0000100016=hmiBoxAktuell.Aus&1),1):((Edge0000100016=hmiBoxAktuell.Aus&1),0))){
(hmiBoxAktuell.DauerbetriebEin=0);
(hmiBoxAktuell.IntervallbetriebEin=0);
(hmiBoxAktuell.NachtrocknungEin=0);
}else if((hmiBoxAktuell.DauerbetriebEin&~Edge0000100017&1?((Edge0000100017=hmiBoxAktuell.DauerbetriebEin&1),1):((Edge0000100017=hmiBoxAktuell.DauerbetriebEin&1),0))){
(hmiBoxAktuell.Aus=0);
(hmiBoxAktuell.IntervallbetriebEin=0);
(hmiBoxAktuell.NachtrocknungEin=0);
}else if((hmiBoxAktuell.IntervallbetriebEin&~Edge0000100018&1?((Edge0000100018=hmiBoxAktuell.IntervallbetriebEin&1),1):((Edge0000100018=hmiBoxAktuell.IntervallbetriebEin&1),0))){
(hmiBoxAktuell.Aus=0);
(hmiBoxAktuell.DauerbetriebEin=0);
(hmiBoxAktuell.NachtrocknungEin=0);
}else if((hmiBoxAktuell.NachtrocknungEin&~Edge0000100019&1?((Edge0000100019=hmiBoxAktuell.NachtrocknungEin&1),1):((Edge0000100019=hmiBoxAktuell.NachtrocknungEin&1),0))){
(hmiBoxAktuell.Aus=0);
(hmiBoxAktuell.DauerbetriebEin=0);
(hmiBoxAktuell.IntervallbetriebEin=0);
}
...
(TOF_VerzBetriebsartBox.IN=((TOF_BoxAufgerufen.Q^1)&((hmiBoxAktuell.Aus^Edge0000100020&1?((Edge0000100020=hmiBoxAktuell.Aus&1),1):((Edge0000100020=hmiBoxAktuell.Aus&1),0))|(hmiBoxAktuell.DauerbetriebEin^Edge0000100021&1?((Edge0000100021=hmiBoxAktuell.DauerbetriebEin&1),1):((Edge0000100021=hmiBoxAktuell.DauerbetriebEin&1),0))|(hmiBoxAktuell.IntervallbetriebEin^Edge0000100022&1?((Edge0000100022=hmiBoxAktuell.IntervallbetriebEin&1),1):((Edge0000100022=hmiBoxAktuell.IntervallbetriebEin&1),0))|(hmiBoxAktuell.NachtrocknungEin^Edge0000100023&1?((Edge0000100023=hmiBoxAktuell.NachtrocknungEin&1),1):((Edge0000100023=hmiBoxAktuell.NachtrocknungEin&1),0)))));;(TOF_VerzBetriebsartBox.PT=Betriebsparameter.Allgemein.VerzUmschBetriebsartBoxen);;TOF(&TOF_VerzBetriebsartBox);



(TOF_BoxAufgerufen.IN=((hmiButtons.showBox1&~Edge0000100024&1?((Edge0000100024=hmiButtons.showBox1&1),1):((Edge0000100024=hmiButtons.showBox1&1),0))|(hmiButtons.showBox2&~Edge0000100025&1?((Edge0000100025=hmiButtons.showBox2&1),1):((Edge0000100025=hmiButtons.showBox2&1),0))|(hmiButtons.showBox3&~Edge0000100026&1?((Edge0000100026=hmiButtons.showBox3&1),1):((Edge0000100026=hmiButtons.showBox3&1),0))|(hmiButtons.showBox4&~Edge0000100027&1?((Edge0000100027=hmiButtons.showBox4&1),1):((Edge0000100027=hmiButtons.showBox4&1),0))|(hmiButtons.showBox5&~Edge0000100028&1?((Edge0000100028=hmiButtons.showBox5&1),1):((Edge0000100028=hmiButtons.showBox5&1),0))|(hmiButtons.showBox6&~Edge0000100029&1?((Edge0000100029=hmiButtons.showBox6&1),1):((Edge0000100029=hmiButtons.showBox6&1),0))));;(TOF_BoxAufgerufen.PT=(500));;TOF(&TOF_BoxAufgerufen);
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100030&1?((Edge0000100030=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100030=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100031&1?((Edge0000100031=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100031=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100032&1?((Edge0000100032=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100032=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((hmiButtons.showBox1&~Edge0000100033&1?((Edge0000100033=hmiButtons.showBox1&1),1):((Edge0000100033=hmiButtons.showBox1&1),0))){
...
if((hmiButtons.showBox2&~Edge0000100034&1?((Edge0000100034=hmiButtons.showBox2&1),1):((Edge0000100034=hmiButtons.showBox2&1),0))){
...
if((hmiButtons.showBox3&~Edge0000100035&1?((Edge0000100035=hmiButtons.showBox3&1),1):((Edge0000100035=hmiButtons.showBox3&1),0))){
...
if((hmiButtons.showBox4&~Edge0000100036&1?((Edge0000100036=hmiButtons.showBox4&1),1):((Edge0000100036=hmiButtons.showBox4&1),0))){
...
if((hmiButtons.showBox5&~Edge0000100037&1?((Edge0000100037=hmiButtons.showBox5&1),1):((Edge0000100037=hmiButtons.showBox5&1),0))){
...
if((hmiButtons.showBox6&~Edge0000100038&1?((Edge0000100038=hmiButtons.showBox6&1),1):((Edge0000100038=hmiButtons.showBox6&1),0))){
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100039&1?((Edge0000100039=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100039=TOF_VerzBetriebsartBox.Q&1),0))){
(hmiParameter.Boxen[CheckBounds(1,1,6)-1].Aus=hmiBoxAktuell.Aus);
(hmiParameter.Boxen[CheckBounds(1,1,6)-1].DauerbetriebEin=hmiBoxAktuell.DauerbetriebEin);
(hmiParameter.Boxen[CheckBounds(1,1,6)-1].IntervallbetriebEin=hmiBoxAktuell.IntervallbetriebEin);
(hmiParameter.Boxen[CheckBounds(1,1,6)-1].NachtrocknungEin=hmiBoxAktuell.NachtrocknungEin);
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100040&1?((Edge0000100040=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100040=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
__AS__MEMCPY(((unsigned long)(&hmiBoxAktuell.Zeitbereiche)),((unsigned long)(&hmiParameter.Boxen[CheckBounds(1,1,6)-1].IntervallbetriebZeiten)),24);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(0,0,23)]=Boxen.Box1Out.IntervallbetriebZeitenGesperrt[CheckBounds(0,0,23)]);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(1,0,23)]=Boxen.Box1Out.IntervallbetriebZeitenGesperrt[CheckBounds(1,0,23)]);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(2,0,23)]=Boxen.Box1Out.IntervallbetriebZeitenGesperrt[CheckBounds(2,0,23)]);
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100041&1?((Edge0000100041=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100041=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
__AS__MEMCPY(((unsigned long)(&hmiBoxAktuell.Zeitbereiche)),((unsigned long)(&hmiParameter.Boxen[CheckBounds(1,1,6)-1].NachtrocknungZeiten)),24);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(0,0,23)]=Boxen.Box1Out.NachtrocknungZeitenGesperrt[CheckBounds(0,0,23)]);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(1,0,23)]=Boxen.Box1Out.NachtrocknungZeitenGesperrt[CheckBounds(1,0,23)]);
(hmiBoxAktuell.ZeitbereicheGesperrt[CheckBounds(2,0,23)]=Boxen.Box1Out.NachtrocknungZeitenGesperrt[CheckBounds(2,0,23)]);
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100042&1?((Edge0000100042=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100042=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100043&1?((Edge0000100043=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100043=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100044&1?((Edge0000100044=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100044=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100045&1?((Edge0000100045=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100045=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100046&1?((Edge0000100046=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100046=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100047&1?((Edge0000100047=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100047=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100048&1?((Edge0000100048=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100048=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100049&1?((Edge0000100049=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100049=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100050&1?((Edge0000100050=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100050=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100051&1?((Edge0000100051=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100051=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100052&1?((Edge0000100052=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100052=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100053&1?((Edge0000100053=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100053=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((~TOF_VerzBetriebsartBox.Q&Edge0000100054&1?((Edge0000100054=TOF_VerzBetriebsartBox.Q&1),1):((Edge0000100054=TOF_VerzBetriebsartBox.Q&1),0))){
...
if((hmiButtons.IntervallEinstellenBoxAktuell&~Edge0000100055&1?((Edge0000100055=hmiButtons.IntervallEinstellenBoxAktuell&1),1):((Edge0000100055=hmiButtons.IntervallEinstellenBoxAktuell&1),0))){
...
if((hmiButtons.NachtrocknEinstellenAktuell&~Edge0000100056&1?((Edge0000100056=hmiButtons.NachtrocknEinstellenAktuell&1),1):((Edge0000100056=hmiButtons.NachtrocknEinstellenAktuell&1),0))){
...
if((hmiButtons.TestbetriebAbschliessen&~Edge0000100057&1?((Edge0000100057=hmiButtons.TestbetriebAbschliessen&1),1):((Edge0000100057=hmiButtons.TestbetriebAbschliessen&1),0))){
...
if(((hmiButtons.TestbetriebAbbrechen&~Edge0000100058&1?((Edge0000100058=hmiButtons.TestbetriebAbbrechen&1),1):((Edge0000100058=hmiButtons.TestbetriebAbbrechen&1),0))|(hmiButtons.TestbetriebEin&~Edge0000100059&1?((Edge0000100059=hmiButtons.TestbetriebEin&1),1):((Edge0000100059=hmiButtons.TestbetriebEin&1),0)))){
(hmiNutzungsdaten.Allgemein.IoTestAbgeschlossen=0);
}
