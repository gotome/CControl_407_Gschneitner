...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV01_EXT/_bur_pvdefst.h"
...
void __AS__ImplInitCSV01_EXTInit_ab(void);
void _INIT __BUR__ENTRY_INIT_BRELF_FUNCT__(void){__AS__ImplInitCSV01_EXTCyclic_ab();
__AS__ImplInitCSV01_EXTInit_ab();
}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV01_EXT/_bur_pvdef.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV01_EXT/_bur_pvdef.st.c\\\" \\\"C:/Program Files/BRAutomation4/AS412/AS/gnuinst/V4.1.2/4.9/arm-elf/include/bur/_bur_pvdef.st\\\"\\n\"");
__asm__(".previous");
