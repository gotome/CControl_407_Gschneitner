...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTrendst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTrend.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTrend.st"
void fbLascoTrend(struct fbLascoTrend* inst){struct fbLascoTrend* __inst__=inst;{


if((__inst__->Freigabe&((__inst__->Zeitspanne!=0)))){


if(((__inst__->ctZeitspanne>=__inst__->Zeitspanne))){

(__inst__->Mittelwert=((float)__inst__->SummeWert/CheckDivReal(__inst__->ctZeitspanne)));


if((((__inst__->Mittelwert-__inst__->MittelwertMEM)!=0))){
(__inst__->Abweichung=(((__inst__->Mittelwert-__inst__->MittelwertMEM)*100)/CheckDivReal(__inst__->ctZeitspanne)));
}else{
(__inst__->Abweichung=(0.00000000000000000000E+00));
}


if(((__inst__->MittelwertMEM<(__inst__->Mittelwert-__inst__->MinAbweichung)))){
(__inst__->TendenzSteigend=1);
}else{
(__inst__->TendenzSteigend=0);
}


if(((__inst__->MittelwertMEM>(__inst__->Mittelwert+__inst__->MinAbweichung)))){
(__inst__->TendenzFallend=1);
}else{
(__inst__->TendenzFallend=0);
}


(__inst__->MittelwertMEM=__inst__->Mittelwert);
(__inst__->ctZeitspanne=(0.00000000000000000000E+00));
(__inst__->SummeWert=(0.00000000000000000000E+00));

}else if(__inst__->Tick){

(__inst__->SummeWert=(__inst__->SummeWert+__inst__->Eingangswert));
(__inst__->ctZeitspanne=(__inst__->ctZeitspanne+1));
...
(__inst__->Abweichung=(0.00000000000000000000E+00));
(__inst__->ctZeitspanne=(0.00000000000000000000E+00));
(__inst__->Mittelwert=(0.00000000000000000000E+00));
(__inst__->MittelwertMEM=(0.00000000000000000000E+00));
(__inst__->SummeWert=(0.00000000000000000000E+00));
(__inst__->TendenzSteigend=0);
(__inst__->TendenzFallend=0);
...
#line 69 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTrend.nodebug"

void __AS__ImplInitfbLascoTrend_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTrend.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTrend.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTrend.st\\\"\\n\"");
