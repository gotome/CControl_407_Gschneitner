...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWarmluftstellerst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWarmluftsteller.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWarmluftsteller.st"
void fbLascoWarmluftsteller(struct fbLascoWarmluftsteller* inst){struct fbLascoWarmluftsteller* __inst__=inst;{
...
(__inst__->curState=__inst__->nextState);

switch(__inst__->curState){
...
(__inst__->locDrehzahl1=__inst__->WLG1SollDRZ);
(__inst__->locDrehzahl2=__inst__->WLG2SollDRZ);
(__inst__->WLG1DRZStell=__inst__->locDrehzahl1);
(__inst__->WLG2DRZStell=__inst__->locDrehzahl2);


if(((__inst__->IstTemperatur<__inst__->GrenzTemperatur))){
(__inst__->nextState=1);
(__inst__->stateEntry=1);
}else{
(__inst__->nextState=__inst__->curState);
}
...
if((((unsigned long)(unsigned char)__inst__->stateEntry==(unsigned long)(unsigned char)1))){
(__inst__->stateEntry=0);
if(((((__inst__->locDrehzahl1-__inst__->MinderungDRZ)>__inst__->WLG1MinDRZ))&(((__inst__->locDrehzahl2-__inst__->MinderungDRZ)>__inst__->WLG2MinDRZ)))){
(__inst__->locDrehzahl1=(__inst__->locDrehzahl1-__inst__->MinderungDRZ));
(__inst__->locDrehzahl2=(__inst__->locDrehzahl2-__inst__->MinderungDRZ));
}else{
(__inst__->locDrehzahl1=__inst__->WLG1MinDRZ);
(__inst__->locDrehzahl2=__inst__->WLG2MinDRZ);
}
(__inst__->TON_WarmluftSteller.IN=1);
(__inst__->TON_WarmluftSteller.Zeit=__inst__->Bezugszeit);
}




(__inst__->TON_WarmluftSteller.Tick=__inst__->Tick);

if((((__inst__->WLG1SollDRZ<__inst__->locDrehzahl1))&((__inst__->WLG2SollDRZ<__inst__->locDrehzahl2)))){
(__inst__->locDrehzahl1=__inst__->WLG1SollDRZ);
(__inst__->locDrehzahl2=__inst__->WLG2SollDRZ);
}
...
if((__inst__->TON_WarmluftSteller.Q&((__inst__->IstTemperatur<=__inst__->GrenzTemperatur)))){
(__inst__->nextState=1);
(__inst__->stateEntry=1);
(__inst__->TON_WarmluftSteller.IN=0);


}else if((__inst__->TON_WarmluftSteller.Q&((__inst__->IstTemperatur>__inst__->GrenzTemperatur)))){
(__inst__->nextState=2);
(__inst__->stateEntry=1);
(__inst__->TON_WarmluftSteller.IN=0);
}else{
(__inst__->nextState=__inst__->curState);
...
if((((unsigned long)(unsigned char)__inst__->stateEntry==(unsigned long)(unsigned char)1))){
(__inst__->stateEntry=0);
if((((__inst__->locDrehzahl1<__inst__->WLG1MinDRZ))&((__inst__->locDrehzahl2<__inst__->WLG2MinDRZ)))){
(__inst__->locDrehzahl1=__inst__->WLG1MinDRZ);
(__inst__->locDrehzahl2=__inst__->WLG2MinDRZ);
}

if(((((__inst__->locDrehzahl1+__inst__->MinderungDRZ)<__inst__->WLG1SollDRZ))&(((__inst__->locDrehzahl2+__inst__->MinderungDRZ)<__inst__->WLG2SollDRZ)))){
(__inst__->locDrehzahl1=(__inst__->locDrehzahl1+__inst__->MinderungDRZ));
(__inst__->locDrehzahl2=(__inst__->locDrehzahl2+__inst__->MinderungDRZ));
}else{
(__inst__->locDrehzahl1=__inst__->WLG1SollDRZ);
...
if((((__inst__->locDrehzahl1>=__inst__->WLG1SollDRZ))&((__inst__->locDrehzahl2>=__inst__->WLG2SollDRZ)))){
(__inst__->nextState=0);
(__inst__->stateEntry=1);
(__inst__->TON_WarmluftSteller.IN=0);

}else if(((((unsigned long)(unsigned char)__inst__->TON_WarmluftSteller.Q==(unsigned long)(unsigned char)1))&((__inst__->IstTemperatur<=__inst__->GrenzTemperatur)))){
(__inst__->nextState=1);
(__inst__->stateEntry=1);
(__inst__->TON_WarmluftSteller.IN=0);
...
(__inst__->nextState=0);
(__inst__->locDrehzahl1=(0.00000000000000000000E+00));
(__inst__->locDrehzahl2=(0.00000000000000000000E+00));
(__inst__->WLG1DRZStell=(0.00000000000000000000E+00));
(__inst__->WLG2DRZStell=(0.00000000000000000000E+00));
(__inst__->TON_WarmluftSteller.IN=0);

}

fbLascoTON(&__inst__->TON_WarmluftSteller);


}}
#line 161 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWarmluftsteller.nodebug"

void __AS__ImplInitfbLascoWarmluftsteller_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWarmluftsteller.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWarmluftsteller.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWarmluftsteller.st\\\"\\n\"");
