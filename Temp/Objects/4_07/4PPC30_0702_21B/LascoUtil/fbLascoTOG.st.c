...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTOGst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTOG.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTOG.st"
void fbLascoTOG(struct fbLascoTOG* inst){struct fbLascoTOG* __inst__=inst;{

if(__inst__->Reset){
(__inst__->Q=0);
(__inst__->ToggImp=0);

}else if((__inst__->IN^1)){
(__inst__->ToggImp=0);

}else if((__inst__->IN&(__inst__->ToggImp^1)&(__inst__->Q^1))){
(__inst__->Q=1);
(__inst__->ToggImp=1);

}else if((__inst__->IN&(__inst__->ToggImp^1)&__inst__->Q)){
(__inst__->Q=0);
(__inst__->ToggImp=1);
}
...
}imp1_else0_3:imp1_end0_0:;}
#line 36 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTOG.nodebug"

void __AS__ImplInitfbLascoTOG_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTOG.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoTOG.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoTOG.st\\\"\\n\"");
