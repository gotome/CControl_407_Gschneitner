...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWoPrgst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWoPrg.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWoPrg.st"
void fbLascoWoPrg(struct fbLascoWoPrg* inst){struct fbLascoWoPrg* __inst__=inst;{



(__inst__->EUhr.Freigabe=1);;fbLascoEUhr(&__inst__->EUhr);
(__inst__->WoTag=__inst__->EUhr.WoTag);
(__inst__->AktZeit=(float)__inst__->EUhr.StdMin);
...
(__inst__->StartZeit_1=((__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ1_Std_Ein*100)+__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ1_Min_Ein));
(__inst__->StopZeit_1=((__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ1_Std_Aus*100)+__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ1_Min_Aus));

(__inst__->FreigabeZeit_1=0);
if(((__inst__->StartZeit_1>__inst__->StopZeit_1))){
if((((__inst__->AktZeit>=__inst__->StartZeit_1))|((__inst__->AktZeit<__inst__->StopZeit_1)))){
(__inst__->FreigabeZeit_1=1);
}
}else{
if((((__inst__->AktZeit>=__inst__->StartZeit_1))&((__inst__->AktZeit<__inst__->StopZeit_1)))){
(__inst__->FreigabeZeit_1=1);
...
(__inst__->StartZeit_2=((__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ2_Std_Ein*100)+__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ2_Min_Ein));
(__inst__->StopZeit_2=((__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ2_Std_Aus*100)+__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ2_Min_Aus));

(__inst__->FreigabeZeit_2=0);
if(((__inst__->StartZeit_2>__inst__->StopZeit_2))){
if((((__inst__->AktZeit>=__inst__->StartZeit_2))|((__inst__->AktZeit<__inst__->StopZeit_2)))){
(__inst__->FreigabeZeit_2=1);
}
}else{
if((((__inst__->AktZeit>=__inst__->StartZeit_2))&((__inst__->AktZeit<__inst__->StopZeit_2)))){
(__inst__->FreigabeZeit_2=1);
...
(__inst__->WoPrgFreigabe=((__inst__->FreigabeZeit_1&__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ1_Enable)|(__inst__->FreigabeZeit_2&__inst__->WoPrg[CheckBounds(__inst__->WoTag,0,7)].HZ2_Enable)));
}else{

(__inst__->WoPrgFreigabe=0);

}

}imp1_end6_0:;}
#line 67 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWoPrg.nodebug"

void __AS__ImplInitfbLascoWoPrg_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWoPrg.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoWoPrg.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoWoPrg.st\\\"\\n\"");
