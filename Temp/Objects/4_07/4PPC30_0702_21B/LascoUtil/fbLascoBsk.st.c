...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBskst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBsk.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBsk.st"
void fbLascoBsk(struct fbLascoBsk* inst){struct fbLascoBsk* __inst__=inst;{


if(__inst__->Freigabe){


(__inst__->TON_FahrzeitAuf.IN=(__inst__->KlappeAuf&(__inst__->KlappeIstOffen^1)&(__inst__->QuitFehler^1)));;(__inst__->TON_FahrzeitAuf.PT=__inst__->FahrzeitAuf);;TON(&__inst__->TON_FahrzeitAuf);
(__inst__->TON_FahrzeitZu.IN=((__inst__->KlappeAuf^1)&(__inst__->KlappeIstGeschlossen^1)&(__inst__->QuitFehler^1)));;(__inst__->TON_FahrzeitZu.PT=__inst__->FahrzeitZu);;TON(&__inst__->TON_FahrzeitZu);

(__inst__->FehlerFahrzeitAuf=__inst__->TON_FahrzeitAuf.Q);
(__inst__->FehlerFahrzeitZu=__inst__->TON_FahrzeitZu.Q);


if((__inst__->Stoerung|(__inst__->KlappeIstOffen&__inst__->KlappeIstGeschlossen))){
(__inst__->Fehler=1);
}else{
(__inst__->Fehler=0);
}
...
(__inst__->KlappeAuf=(__inst__->Oeffnen&(__inst__->Fehler^1)));

}else{

(__inst__->KlappeAuf=0);
(__inst__->Fehler=0);
(__inst__->FehlerFahrzeitAuf=0);
(__inst__->FehlerFahrzeitZu=0);
(__inst__->TON_FahrzeitAuf.IN=0);;TON(&__inst__->TON_FahrzeitAuf);
(__inst__->TON_FahrzeitZu.IN=0);;TON(&__inst__->TON_FahrzeitZu);

}


}imp1_end0_0:;}
#line 52 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBsk.nodebug"

void __AS__ImplInitfbLascoBsk_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBsk.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBsk.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBsk.st\\\"\\n\"");
