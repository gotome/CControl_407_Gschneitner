...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZundst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZund.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZund.st"
void fbLascoZund(struct fbLascoZund* inst){struct fbLascoZund* __inst__=inst;{


(__inst__->TON_Zuendzeit.IN=__inst__->Freigabe);;(__inst__->TON_Zuendzeit.Zeit=__inst__->Zuendzeit);;(__inst__->TON_Zuendzeit.Tick=__inst__->Tick);;fbLascoTON(&__inst__->TON_Zuendzeit);

if((((unsigned long)(unsigned char)__inst__->Freigabe==(unsigned long)(unsigned char)1))){


if(((__inst__->IstTemp>__inst__->SollTemp))){
(__inst__->Zuendspule=0);
(__inst__->ZuendungOK=1);
(__inst__->ZuendungFehler=0);


}else if((((__inst__->IstTemp<__inst__->SollTemp))&__inst__->TON_Zuendzeit.Q)){
(__inst__->Zuendspule=0);
(__inst__->ZuendungOK=0);
(__inst__->ZuendungFehler=1);


}else{
(__inst__->Zuendspule=1);
(__inst__->ZuendungOK=0);
(__inst__->ZuendungFehler=0);
}


(__inst__->TOF_Nachlaufzeit.IN=__inst__->Zuendspule);;(__inst__->TOF_Nachlaufzeit.Zeit=__inst__->Nachlaufzeit);;(__inst__->TOF_Nachlaufzeit.Tick=__inst__->Tick);;fbLascoTOF(&__inst__->TOF_Nachlaufzeit);

(__inst__->Zuendgeblaese=__inst__->TOF_Nachlaufzeit.Q);


}else{

if((((unsigned long)(unsigned char)__inst__->Zuendspule==(unsigned long)(unsigned char)1))){
(__inst__->Zuendspule=0);
}
...
#line 61 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZund.nodebug"

void __AS__ImplInitfbLascoZund_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZund.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZund.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZund.st\\\"\\n\"");
