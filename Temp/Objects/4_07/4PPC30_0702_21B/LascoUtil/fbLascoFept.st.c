...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoFeptst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoFept.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoFept.st"
void fbLascoFept(struct fbLascoFept* inst){struct fbLascoFept* __inst__=inst;{



if((__inst__->Quit&((__inst__->IN<750))&((__inst__->IN>(-50))))){
(__inst__->Q=0);
(__inst__->Counter=0);


}else if(((__inst__->Quit&__inst__->Q)|(__inst__->Enable^1))){
(__inst__->Q=0);
(__inst__->Counter=0);


}else if(((__inst__->Counter>=__inst__->VerzZeit))){
(__inst__->Q=1);


}else if((((__inst__->IN>750))|((__inst__->IN<(-50))))){
...
#line 39 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoFept.nodebug"

void __AS__ImplInitfbLascoFept_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoFept.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoFept.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoFept.st\\\"\\n\"");
