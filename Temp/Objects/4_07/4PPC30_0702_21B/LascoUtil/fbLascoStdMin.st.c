...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStdMinst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStdMin.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStdMin.st"
void fbLascoStdMin(struct fbLascoStdMin* inst){struct fbLascoStdMin* __inst__=inst;{

if((((unsigned long)(unsigned char)(CheckReadAccess(__inst__->Minuten),(*(__inst__->Minuten)))>(unsigned long)(unsigned char)59))){
(CheckWriteAccess(__inst__->Stunden),(*(__inst__->Stunden))=((CheckReadAccess(__inst__->Stunden),(*(__inst__->Stunden)))+1));
(CheckWriteAccess(__inst__->Minuten),(*(__inst__->Minuten))=0);
}

if(__inst__->Reset){
(CheckWriteAccess(__inst__->Stunden),(*(__inst__->Stunden))=0);
(CheckWriteAccess(__inst__->Minuten),(*(__inst__->Minuten))=0);
}

}imp1_else1_0:imp1_end1_0:;}
#line 25 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStdMin.nodebug"

void __AS__ImplInitfbLascoStdMin_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStdMin.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStdMin.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStdMin.st\\\"\\n\"");
