...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZweiPunktAchsest.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZweiPunktAchse.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZweiPunktAchse.st"
void fbLascoZweiPunktAchse(struct fbLascoZweiPunktAchse* inst){struct fbLascoZweiPunktAchse* __inst__=inst;{

if((__inst__->Freigabe&(__inst__->Stoerung^1))){


(__inst__->TON_Ansprechzeit.IN=__inst__->Vor);;(__inst__->TON_Ansprechzeit.Zeit=__inst__->AnsprechZeit);;(__inst__->TON_Ansprechzeit.Tick=__inst__->Tick);;fbLascoTON(&__inst__->TON_Ansprechzeit);


(__inst__->TOF_Laufzeit.IN=__inst__->TON_Ansprechzeit.Q);;(__inst__->TOF_Laufzeit.Zeit=__inst__->MinLaufZeit);;(__inst__->TOF_Laufzeit.Tick=__inst__->Tick);;fbLascoTOF(&__inst__->TOF_Laufzeit);

(__inst__->loc_Vor=__inst__->TOF_Laufzeit.Q);


(__inst__->TON_AnsprechzeitZurueck.IN=__inst__->Zurueck);;(__inst__->TON_AnsprechzeitZurueck.Zeit=__inst__->AnsprechZeit);;(__inst__->TON_AnsprechzeitZurueck.Tick=__inst__->Tick);;fbLascoTON(&__inst__->TON_AnsprechzeitZurueck);


(__inst__->TOF_LaufzeitZurueck.IN=__inst__->TON_AnsprechzeitZurueck.Q);;(__inst__->TOF_LaufzeitZurueck.Zeit=__inst__->MinLaufZeit);;(__inst__->TOF_LaufzeitZurueck.Tick=__inst__->Tick);;fbLascoTOF(&__inst__->TOF_LaufzeitZurueck);

(__inst__->loc_Zurueck=__inst__->TOF_LaufzeitZurueck.Q);



if((__inst__->loc_Vor&(__inst__->ESVor^1)&(__inst__->Stoerung^1)&(__inst__->loc_Zurueck^1))){
(__inst__->Motor_Vor=1);
(__inst__->Motor_Zurueck=0);


}else if((__inst__->loc_Zurueck&(__inst__->ESZurueck^1)&(__inst__->Stoerung^1)&(__inst__->loc_Vor^1))){
(__inst__->Motor_Vor=0);
(__inst__->Motor_Zurueck=1);


}else if((__inst__->loc_Zurueck&(__inst__->ESVor^1)&(__inst__->Stoerung^1)&(__inst__->loc_Zurueck^1))){
(__inst__->Motor_Vor=0);
(__inst__->Motor_Zurueck=0);
(__inst__->loc_Vor=0);
(__inst__->loc_Zurueck=0);
...
if((__inst__->loc_Vor&__inst__->loc_Zurueck)){
(__inst__->Motor_Vor=0);
(__inst__->Motor_Zurueck=0);
}
...
if(((__inst__->ESVor&__inst__->ESZurueck)|__inst__->Stoerung)){
(__inst__->Motor_Vor=0);
(__inst__->Motor_Zurueck=0);
(__inst__->Fehler=1);
...
#line 83 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZweiPunktAchse.nodebug"

void __AS__ImplInitfbLascoZweiPunktAchse_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZweiPunktAchse.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoZweiPunktAchse.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoZweiPunktAchse.st\\\"\\n\"");
