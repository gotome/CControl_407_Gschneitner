...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBminst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBmin.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBmin.st"
void fbLascoBmin(struct fbLascoBmin* inst){struct fbLascoBmin* __inst__=inst;{

if((__inst__->Aktiv&__inst__->sekTick)){
if((((unsigned long)(unsigned char)__inst__->Sekunden<(unsigned long)(unsigned char)59))){
(__inst__->Sekunden=(__inst__->Sekunden+1));
}else{
(CheckWriteAccess(__inst__->Minuten),(*(__inst__->Minuten))=((CheckReadAccess(__inst__->Minuten),(*(__inst__->Minuten)))+1));
(__inst__->Sekunden=0);
}
}
...
#line 31 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBmin.nodebug"

void __AS__ImplInitfbLascoBmin_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBmin.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoBmin.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoBmin.st\\\"\\n\"");
