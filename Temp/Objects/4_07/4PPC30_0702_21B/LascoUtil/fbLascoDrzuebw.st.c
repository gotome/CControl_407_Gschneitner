...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoDrzuebwst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoDrzuebw.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoDrzuebw.st"
void fbLascoDrzuebw(struct fbLascoDrzuebw* inst){struct fbLascoDrzuebw* __inst__=inst;{
...
if((__inst__->Motor&(__inst__->Impuls^1))){
(__inst__->nextStep=1);


}else if((__inst__->Motor&__inst__->Impuls)){
(__inst__->nextStep=2);
}
...
(__inst__->Fehler=0);
(__inst__->ElapsedTime=(__inst__->ElapsedTime+__inst__->Tick));




if(((__inst__->ElapsedTime>=__inst__->Zeit))){
(__inst__->nextStep=255);


}else if(__inst__->Impuls){
(__inst__->ElapsedTime=0);
(__inst__->nextStep=2);


}else if((__inst__->Motor^1)){
(__inst__->ElapsedTime=0);
(__inst__->nextStep=0);
}
...
}imp1_case0_3:imp1_endcase0_0:;}
#line 114 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoDrzuebw.nodebug"

void __AS__ImplInitfbLascoDrzuebw_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoDrzuebw.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoDrzuebw.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoDrzuebw.st\\\"\\n\"");
