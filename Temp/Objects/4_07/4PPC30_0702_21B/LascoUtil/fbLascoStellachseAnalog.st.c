...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStellachseAnalogst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStellachseAnalog.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStellachseAnalog.st"
void fbLascoStellachseAnalog(struct fbLascoStellachseAnalog* inst){struct fbLascoStellachseAnalog* __inst__=inst;{

if((__inst__->Freigabe&(__inst__->Stoerung^1))){


if((((__inst__->SollStellung<(__inst__->IstStellung-__inst__->Hysterese)))&(__inst__->EsVor^1))){
(__inst__->MotorStellung=__inst__->SollStellung);
}else if((((__inst__->SollStellung>(__inst__->IstStellung+__inst__->Hysterese)))&(__inst__->EsZurueck^1))){
(__inst__->MotorStellung=__inst__->SollStellung);


}else{
(__inst__->MotorStellung=__inst__->IstStellung);
}
}else{
(__inst__->MotorStellung=__inst__->IstStellung);
}
...
#line 41 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStellachseAnalog.nodebug"

void __AS__ImplInitfbLascoStellachseAnalog_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStellachseAnalog.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoStellachseAnalog.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoStellachseAnalog.st\\\"\\n\"");
