...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoSrvcIntervst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoSrvcInterv.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoSrvcInterv.st"
void fbLascoSrvcInterv(struct fbLascoSrvcInterv* inst){struct fbLascoSrvcInterv* __inst__=inst;{


if((__inst__->SrvcReset&~__inst__->zzEdge00000&1?((__inst__->zzEdge00000=__inst__->SrvcReset&1),1):((__inst__->zzEdge00000=__inst__->SrvcReset&1),0))){
(CheckWriteAccess(__inst__->ZeitBisSrvc),(*(__inst__->ZeitBisSrvc))=__inst__->SrvcIntervall);
}


if(((__inst__->Aktiv&__inst__->Tick)&(((unsigned long)(CheckReadAccess(__inst__->ZeitBisSrvc),(*(__inst__->ZeitBisSrvc)))>(unsigned long)0)))){
(CheckWriteAccess(__inst__->ZeitBisSrvc),(*(__inst__->ZeitBisSrvc))=((CheckReadAccess(__inst__->ZeitBisSrvc),(*(__inst__->ZeitBisSrvc)))-1));
}


if((((unsigned long)(CheckReadAccess(__inst__->ZeitBisSrvc),(*(__inst__->ZeitBisSrvc)))==(unsigned long)0))){
(__inst__->SrvcErforderl=1);
}else{
(__inst__->SrvcErforderl=0);
}

}imp1_end2_0:;}
#line 32 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoSrvcInterv.nodebug"

void __AS__ImplInitfbLascoSrvcInterv_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoSrvcInterv.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoUtil/fbLascoSrvcInterv.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoUtil/fbLascoSrvcInterv.st\\\"\\n\"");
