...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV/CSV_GRP_dateab.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/CSV/Library/CSV/CSV_GRP_date.nodebug"
#line 26 "C:/SharedFolder/CControl_407_Gschneitner/Logical/CSV/Library/CSV/CSV_GRP_date.ab"
void CSV_GRP_date(struct CSV_GRP_date* inst){struct CSV_GRP_date* __inst__=inst;

__AS__MEMSET(((unsigned long)(&__inst__->M_DATE)),0,11);

if((((unsigned long)__inst__->Ausg_date_len>=(unsigned long)11))){
...
__AS__STRCPY(((unsigned long)(&__inst__->M_DATE)),((unsigned long)(&__inst__->Str_Jahr)));
__AS__STRCAT(((unsigned long)(&__inst__->M_DATE)),((unsigned long)(&"-")));
__AS__STRCAT(((unsigned long)(&__inst__->M_DATE)),((unsigned long)(&__inst__->Str_Mon)));
__AS__STRCAT(((unsigned long)(&__inst__->M_DATE)),((unsigned long)(&"-")));
__AS__STRCAT(((unsigned long)(&__inst__->M_DATE)),((unsigned long)(&__inst__->Str_Tag)));

__AS__MEMCPY(__inst__->Ausg_date_adr,((unsigned long)(&__inst__->M_DATE)),__inst__->Ausg_date_len);

}else{

__AS__MEMCPY(__inst__->Ausg_date_adr,((unsigned long)(&__inst__->M_DATE)),11);
(__inst__->Ausg_Fehler=1);

}

imp1_end0_0:;}
#line 51 "C:/SharedFolder/CControl_407_Gschneitner/Logical/CSV/Library/CSV/CSV_GRP_date.nodebug"

void __AS__ImplInitCSV_GRP_date_ab(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV/CSV_GRP_date.ab.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/CSV/CSV_GRP_date.ab.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/CSV/Library/CSV/CSV_GRP_date.ab\\\"\\n\"");
