...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockLaufPausest.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockLaufPause.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockLaufPause.st"
void fbTrockLaufPause(struct fbTrockLaufPause* inst){struct fbTrockLaufPause* __inst__=inst;{





(__inst__->currStep=__inst__->nextStep);


switch(__inst__->currStep){


case 0:{


(__inst__->FreigabeLpPrg=0);

(__inst__->CounterLauf=0);
(__inst__->CounterPause=0);
(__inst__->RestzeitPause=0);
(__inst__->RestzeitLauf=0);


if((__inst__->Freigabe&(((unsigned long)__inst__->ZeitLauf!=(unsigned long)0))&(((unsigned long)__inst__->ZeitLauf>=(unsigned long)__inst__->ZeitLaufMin))&(__inst__->Reset^1))){
(__inst__->nextStep=2);
}else{
(__inst__->nextStep=__inst__->currStep);
}
...
if((__inst__->Tick&~__inst__->zzEdge00000&1?((__inst__->zzEdge00000=__inst__->Tick&1),1):((__inst__->zzEdge00000=__inst__->Tick&1),0))){
(__inst__->CounterPause=(__inst__->CounterPause+1));
}

(__inst__->RestzeitPause=(__inst__->ZeitPause-__inst__->CounterPause));
(__inst__->RestzeitLauf=0);



if(((__inst__->Freigabe^1)|(((unsigned long)__inst__->ZeitLauf==(unsigned long)0))|(((unsigned long)__inst__->ZeitLauf<(unsigned long)__inst__->ZeitLaufMin))|__inst__->Reset)){
(__inst__->nextStep=0);
}else if((((unsigned long)__inst__->CounterPause>=(unsigned long)__inst__->ZeitPause))){
(__inst__->CounterPause=0);
(__inst__->nextStep=2);
}
...
(__inst__->FreigabeLpPrg=1);

if((__inst__->Tick&~__inst__->zzEdge00001&1?((__inst__->zzEdge00001=__inst__->Tick&1),1):((__inst__->zzEdge00001=__inst__->Tick&1),0))){
(__inst__->CounterLauf=(__inst__->CounterLauf+1));
}

(__inst__->RestzeitPause=0);
(__inst__->RestzeitLauf=(__inst__->ZeitLauf-__inst__->CounterLauf));


if(((__inst__->Freigabe^1)|(((unsigned long)__inst__->ZeitLauf<(unsigned long)__inst__->ZeitLaufMin))|__inst__->Reset)){
(__inst__->nextStep=0);
}else if((((unsigned long)__inst__->CounterLauf>=(unsigned long)__inst__->ZeitLauf))){
(__inst__->CounterLauf=0);
(__inst__->nextStep=1);
}
...
#line 92 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockLaufPause.nodebug"

void __AS__ImplInitfbTrockLaufPause_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockLaufPause.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockLaufPause.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockLaufPause.st\\\"\\n\"");
