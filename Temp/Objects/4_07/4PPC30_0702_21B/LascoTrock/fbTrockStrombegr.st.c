...
#include "C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockStrombegrst.h"
#line 1 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockStrombegr.nodebug"
#line 13 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockStrombegr.st"
void fbTrockStrombegr(struct fbTrockStrombegr* inst){struct fbTrockStrombegr* __inst__=inst;{
...
if(__inst__->FreigZeitfenster1){
(__inst__->DrehzahlBegrenzung=__inst__->DrehzahlBegrenzung1);
}else if(__inst__->FreigZeitfenster2){
(__inst__->DrehzahlBegrenzung=__inst__->DrehzahlBegrenzung2);
}else if(__inst__->FreigZeitfenster3){
(__inst__->DrehzahlBegrenzung=__inst__->DrehzahlBegrenzung3);
}else{
(__inst__->DrehzahlBegrenzung=(0.00000000000000000000E+00));
}


(__inst__->StrombegrenzungEin=(__inst__->FreigZeitfenster1|__inst__->FreigZeitfenster2|__inst__->FreigZeitfenster3));
...
#line 89 "C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockStrombegr.nodebug"

void __AS__ImplInitfbTrockStrombegr_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockStrombegr.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl_407_Gschneitner/Temp/Objects/4_07/4PPC30_0702_21B/LascoTrock/fbTrockStrombegr.st.c\\\" \\\"C:/SharedFolder/CControl_407_Gschneitner/Logical/Libraries/LascoTrock/fbTrockStrombegr.st\\\"\\n\"");
