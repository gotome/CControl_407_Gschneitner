...
#include "C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/hmiConnect/Mainst.h"
#line 1 "C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.nodebug"
#line 2 "C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiStatus.SoftwareVersion; plcstring* zzRValue=(plcstring*)VERSION; for(zzIndex=0; zzIndex<16l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};


}}
#line 34 "C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.nodebug"
#line 36 "C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.st"
...
(loc_Box1Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[1-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(loc_Box2Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[2-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(loc_Box3Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[3-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(loc_Box4Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[4-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(loc_Box5Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[5-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
(loc_Box6Beendet=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)hmiTrocknungsbilanz.NameBox; plcstring* zzRValue=(plcstring*)hmiParameter.Boxen[6-1].NameBox; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 737 "C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/hmiConnect/Main.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/hmiConnect/Main.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/Visualisierung/hmiConnect/Main.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/4_07_Plus/4PPC30_0702_21B/hmiConnect/Main.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
