...
#include "C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/LascoUtil/fbLascoPugest.h"
#line 1 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoPuge.nodebug"
#line 13 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoPuge.st"
...
(__inst__->CounterPause=(__inst__->CounterPause+__inst__->Tick));
(__inst__->RestzeitPause=(__inst__->ZeitPause-__inst__->CounterPause));
(__inst__->RestzeitPuls=0);



if((((__inst__->StartMitPause^1)&(__inst__->StartMitPuls^1))|((__inst__->ZeitPuls==0)))){
(__inst__->nextStep=0);
}else if(((__inst__->CounterPause>=__inst__->ZeitPause))){
(__inst__->CounterPause=0);
(__inst__->nextStep=2);
}
...
(__inst__->CounterPuls=(__inst__->CounterPuls+__inst__->Tick));
(__inst__->RestzeitPause=0);
(__inst__->RestzeitPuls=(__inst__->ZeitPuls-__inst__->CounterPuls));


if((((__inst__->CounterPuls>=__inst__->ZeitPuls))|__inst__->Reset)){
(__inst__->CounterPuls=0);
(__inst__->nextStep=1);
}
...
#line 91 "C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoPuge.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/LascoUtil/fbLascoPuge.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/LascoUtil/fbLascoPuge.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/Libraries/LascoUtil/fbLascoPuge.st\\\"\\n\"");
