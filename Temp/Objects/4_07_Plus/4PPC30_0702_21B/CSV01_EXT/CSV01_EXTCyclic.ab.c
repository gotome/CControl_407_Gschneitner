...
#include "C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/CSV01_EXT/CSV01_EXTCyclicab.h"
#line 1 "C:/SharedFolder/CControl/Logical/CSV/CSV01_EXT/CSV01_EXTCyclic.nodebug"
#line 4 "C:/SharedFolder/CControl/Logical/CSV/CSV01_EXT/CSV01_EXTCyclic.ab"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.File_Name; plcstring* zzRValue=(plcstring*)CSV01.IW.File_Name; for(zzIndex=0; zzIndex<100l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.RPS_File_Name; plcstring* zzRValue=(plcstring*)CSV01.IW.RPS_File_Name; for(zzIndex=0; zzIndex<200l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.PC_Zielpfad; plcstring* zzRValue=(plcstring*)CSV01.IW.PC_Zielpfad; for(zzIndex=0; zzIndex<100l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.EXT_Zielpfad; plcstring* zzRValue=(plcstring*)CSV01.IW.EXT_Zielpfad; for(zzIndex=0; zzIndex<100l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.DirRead_FileName_neu; plcstring* zzRValue=(plcstring*)CSV01.IW.DirRead_FileName_neu; for(zzIndex=0; zzIndex<260l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)CSV01.IW.DirRead_FileName_alt; plcstring* zzRValue=(plcstring*)CSV01.IW.DirRead_FileName_alt; for(zzIndex=0; zzIndex<260l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
#line 174 "C:/SharedFolder/CControl/Logical/CSV/CSV01_EXT/CSV01_EXTCyclic.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/CSV01_EXT/CSV01_EXTCyclic.ab.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/CSV01_EXT/CSV01_EXTCyclic.ab.c\\\" \\\"C:/SharedFolder/CControl/Logical/CSV/CSV01_EXT/CSV01_EXTCyclic.ab\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/4_07_Plus/4PPC30_0702_21B/CSV01_EXT/CSV01_EXTCyclic.ab.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");
