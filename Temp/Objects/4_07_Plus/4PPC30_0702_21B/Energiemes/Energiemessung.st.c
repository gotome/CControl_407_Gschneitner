...
#include "C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/Energiemes/Energiemessungst.h"
#line 1 "C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.nodebug"
#line 3 "C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.st"
...
#line 8 "C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.nodebug"
#line 11 "C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.st"
void _CYCLIC __BUR__ENTRY_CYCLIC_FUNCT__(void){{



if(apModulEnergie.RBClearEnergy){
(apModulEnergie.ClearEnergy=0);
}
...
(loc_LeistungAkt=(float)apModulEnergie.PmeanT);
(loc_EnergieSchein=(float)apModulEnergie.SAenergyT);


(hmiNutzungsdaten.Energiemessung.LeistungAktuell=((loc_LeistungAkt*4)/CheckDivReal(100)));
(loc_EnergieGesamt=(loc_EnergieSchein/CheckDivReal(360)));


if(hmiButtons.ResetEnergieverbrTag){
(hmiButtons.ResetEnergieverbrTag=0);
(loc_EnergieMinute=0.00000000000000000000E+00);
(hmiNutzungsdaten.Energiemessung.EnergieTag=0.00000000000000000000E+00);
}else if(minTick){
...
#line 61 "C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/Energiemes/Energiemessung.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/SharedFolder/CControl/Temp/Objects/4_07_Plus/4PPC30_0702_21B/Energiemes/Energiemessung.st.c\\\" \\\"C:/SharedFolder/CControl/Logical/IO/Energiemessung/Energiemessung.st\\\"\\n\"");
__asm__(".previous");
